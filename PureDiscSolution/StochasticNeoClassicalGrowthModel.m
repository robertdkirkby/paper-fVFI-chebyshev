...
% 24 & 84 are roughly those that the Smolyak-Chebyshev codes are using.
k_grid=linspace(24,84,n_k)'; % Grids should always be declared as column vectors
...
PureDiscSoln.V=V;
PureDiscSoln.z_grid=z_grid;
PureDiscSoln.k_grid=k_grid;
PureDiscSoln.Policy=Policy;

save StochasticNeoClassicalGrowthModel_PureDiscSoln.mat PureDiscSoln
